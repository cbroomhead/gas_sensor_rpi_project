...
class MQ():
    ...
    def __init__(self, Ro=10, analogPin=0):
        ...
        self.COCurve = [1, 0.46, -0.23]     # two points are taken from the curve. 
                                            # with these two points, a line is formed which is "approximately equivalent" 
                                            # to the original curve.
                                            # data format:[ x, y, slope]; point1: (lg10, 2.9), point2: (lg200,  1.45)
        self.CO2Curve =[1.0,0.36,-0.35]     # two points are taken from the curve. 
                                            # with these two points, a line is formed which is "approximately equivalent" 
                                            # to the original curve.
                                            # data format:[ x, y, slope]; point1: (lg10, 2.3), point2: (lg200,  0.8)   
        self.NH4Curve =[1, 0.41, -0.41]     # two points are taken from the curve. 
                                            # with these two points, a line is formed which is "approximately equivalent" 
                                            # to the original curve.
                                            # data format:[ x, y, slope]; point1: (lg10, 2.6), point2: (lg200,  0.76)
